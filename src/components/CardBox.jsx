...
import { BsPlus, BsSim } from "react-icons/bs";
    ...
    <>
      ...
      <div className="w-full rounded-xl   shadow md:w-3/12  bg-white text-white md:mx-4 md:my-0 my-2 px-6   py-8 flex justify-start  items-center  flex-col">
        ...
        <div className="w-full flex relative h-full">
          {!flipCard ? (
            <div
              className={`w-full   border ${currentCard.skin}  my-5 rounded-xl py-4 md:h-56 h-52 px-6 flex flex-col justify-between items-center`}
            >
            ...
            <div
              className={`w-full   border ${currentCard.skin}  my-5 rounded-xl  py-2 md:h-56 h-52  px-1 flex flex-col justify-between items-center`}
            >
              ...
              <div className="w-full flex flex-col">
                ...
                <p
                  ...
                  className="px-4 text-left text-xs"
                >
                  This card is issued by and remails the properly of Izeogu
                  andrew Plc.
                  <br />
        ...
        >
          ...
          >
            <button
              className={`bg-black flex justify-center items-center hover:bg-[#5d5dcc] px-2 w-full text-xs text-white py-1 rounded-full`}
            >
              {flipCard ? "Show Front" : "Show Back"}
            </button>
          </div>
        </div>
